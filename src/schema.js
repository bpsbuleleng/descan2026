...
var ANGGOTA_FIELDS=[
  ...
  {rp:'_tglLahir',r:'30',label:'Tanggal Lahir',type:'tglLahir'},
  ...
  {rp:'nilaiKerja',r:'35a',label:'Total pendapatan dari pekerjaan sebulan',type:'rupiah',req:true,when:(k,a)=>/^1\. Ya/.test(a.pendapatanKerja||'')},
  ...
  {rp:'nilaiLain',r:'35c',label:'Total penerimaan lain sebulan',type:'rupiah',req:true,when:(k,a)=>/^1\. Ya/.test(a.pendapatanLain||'')},
